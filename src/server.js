...
import propertyCardRoutes from './routes/propertyCard.js';
...
import buyerAssumptionsRoutes from './routes/buyerAssumptions.js';
...
app.use('/api/properties', propertyCardRoutes);
...
app.use('/api/deal-rooms', dealRoomsRoutes);
