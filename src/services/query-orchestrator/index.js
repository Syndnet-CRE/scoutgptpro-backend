  ...
  try {
    ...
    const features = enriched.properties.map(prop => ({
      ...
      properties: {
        ...
        owner: prop.owner_name_raw,
        owner_type: prop.owner_entity_type,
        acres: prop.acres_calc,
        ...
        tax_delinquent: prop.tax_delinquent_flag,
        homestead: prop.homestead_exemption_flag,
