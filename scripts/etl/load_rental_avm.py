...
CSV_PATH = "scripts/etl/rental_avm_travis.csv"
...
TABLE = "attom_rental_avm"
BATCH_SIZE = 5000

csv.field_size_limit(10 * 1024 * 1024)

COLUMNS = [
    "attomid", "propertyaddressfull", "propertyaddresshousenumber",
    "propertyaddressstreetdirection", "propertyaddressstreetname",
    "propertyaddressstreetsuffix", "propertyaddressstreetpostdirection",
    "propertyaddressunitprefix", "propertyaddressunitvalue",
    "propertyaddresscity", "propertyaddressstate", "propertyaddresszip",
    "propertyaddresszip4", "propertyaddresscrrt",
    "propertyusegroup", "propertyusestandardized",
    "estimatedrentalvalue", "estimatedminrentalvalue", "estimatedmaxrentalvalue",
    "valuationdate", "publicationdate", "dbcreatedate", "dbupdatedate"
]
