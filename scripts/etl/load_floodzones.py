#!/usr/bin/env python3
"""
ATTOM P1 ETL: Load Flood Zones from CSV into Neon PostgreSQL.
Uses CSV-format COPY for reliable escaping.
Expected: 410,656 rows
"""
...
CSV_PATH = "scripts/etl/floodzones_travis.csv"
TABLE = "attom_boundary_floodzones"
BATCH_SIZE = 10000
